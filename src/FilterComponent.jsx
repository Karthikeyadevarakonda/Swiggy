     ...
     <div className="w-1/3 h-80 rounded-2xl bg-white shadow-lg m-auto z-2 p-4 relative">
      ...
      <div>
        ...
        <div className="mb-3 flex items-center">
         <input type="radio" id="default" name="sort" className="mr-2 accent-orange-500" value="default" onChange={(e)=>setTempSort(e.target.value)} checked={tempSort === "default"} />
         <label htmlFor="default" className="font-semibold text-lg text-gray-700">Default</label>
       </div>
        <div className="mb-3 flex items-center">
          <input type="radio" id="rating" name="sort" className="mr-2 accent-orange-500" value="rating" onChange={(e)=>setTempSort(e.target.value)} checked={tempSort === "rating"} />
          <label htmlFor="rating" className="font-semibold text-lg text-gray-700">Rating</label>
       </div>

       <div className="mb-3 flex items-center">
         <input type="radio" id="delivery" name="sort" className="mr-2 accent-orange-500" value="delivery" onChange={(e)=>setTempSort(e.target.value)} checked={tempSort === "delivery"}/>
         <label htmlFor="delivery" className="font-semibold text-lg text-gray-700">Delivery Time</label>
       </div>

       <div className="mb-3 flex items-center">
         <input type="radio" id="cost" name="sort" className="mr-2 accent-orange-500" value="cost" onChange={(e)=>setTempSort(e.target.value)} checked={tempSort === "cost"}/>
